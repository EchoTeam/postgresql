...
public_error_reason_to_string({query_error, Reason}) when is_atom(Reason) ->
    atom_to_list(Reason);
public_error_reason_to_string({query_error, {Code, _Message}}) when is_binary(Code) ->
